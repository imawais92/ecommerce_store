...
?>
<div>
    <img class="d-block w-100" src="img/watch banner.jpg" alt="First slide" height="50%">
</div>
<div class="container">
    <div class="row">
        <?php
        $sql = "SELECT * FROM glory_product WHERE product_category = 'smart_watch'";
...
if (isset($_POST['remove_item'])) {
    ...
    if (isset($_SESSION['cart'][$remove_product_id])) {
        ...
        ?>
        <script>
            window.location.assign('watches.php');
        </script>
        <?php
    }
}
